...
import 'package:teams/detailAbsenOut.dart';
...
class dataAbsenOut extends StatefulWidget {
  @override
  State<dataAbsenOut> createState() => _dataAbsenOutState();
}

class _dataAbsenOutState extends State<dataAbsenOut> {
  String region_id = "",
      branch_id = "",
      location_id = "",
      division_id = "",
  ...
  Future<List> getData() async {
    var url = Uri.parse("$env/teams/getdataout.php");
        ...
        return new Container(
          ...
          child: new GestureDetector(
            onTap: () => Navigator.of(context).push(new MaterialPageRoute(
                builder: (BuildContext context) => new DetailOut(
                      list: list,
                      index: i,
                    ))),
            child: new Card(
