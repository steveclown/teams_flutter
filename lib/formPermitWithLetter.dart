...
import 'package:teams/menuPermitWithLetter.dart';
...
class formPermitWithLetter extends StatefulWidget {
  @override
  State<formPermitWithLetter> createState() => _formPermitWithLetterState();
}

class _formPermitWithLetterState extends State<formPermitWithLetter> {
  File image;
  ...
  savepermit() async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => dataIjinWithLetter()),
