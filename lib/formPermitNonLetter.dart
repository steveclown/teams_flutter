...
class formPermitNonLetter extends StatefulWidget {
  @override
  State<formPermitNonLetter> createState() => _formPermitNonLetterState();
}

class _formPermitNonLetterState extends State<formPermitNonLetter> {
  File image;
  ...
  savepermit() async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => dataIjinNonLetter()),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Formulir Ijin Sakit Tanpa Surat",
          style: TextStyle(
              fontSize: 13,
