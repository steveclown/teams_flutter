...
class DetailOut extends StatefulWidget {
  List list;
  int index;
  DetailOut({this.index, this.list});
  @override
  _DetailOutState createState() => new _DetailOutState();
}

class _DetailOutState extends State<DetailOut> {
  @override
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Detail Absen Pulang"),
