...
import 'package:teams/formPermitNonLetter.dart';
...
class dataIjinNonLetter extends StatefulWidget {
  @override
  State<dataIjinNonLetter> createState() => _dataIjinNonLetterState();
}

class _dataIjinNonLetterState extends State<dataIjinNonLetter> {
  int employee_id;
  int bottomIndex = 0;
